...
import type {
  ...
  ChatIssuePropertyValue,
  FetchInAppChatConversationsArgs,
  SummarizeInAppChatConversationsArgs,
  FetchInAppChatConversationArgs,
  SummarizeInAppChatMessagesArgs,
  SummarizeInAppChatUnreadArgs,
  MarkInAppChatConversationReadArgs,
...
const DashX = {
  ...
  summarizeInAppChatConversations(args: SummarizeInAppChatConversationsArgs) { return ensureConfigured().summarizeInAppChatConversations(args) },
  fetchInAppChatConversation(args: FetchInAppChatConversationArgs) { return ensureConfigured().fetchInAppChatConversation(args) },
  summarizeInAppChatMessages(args: SummarizeInAppChatMessagesArgs) { return ensureConfigured().summarizeInAppChatMessages(args) },
  summarizeInAppChatUnread(args: SummarizeInAppChatUnreadArgs) { return ensureConfigured().summarizeInAppChatUnread(args) },
  markInAppChatConversationRead(args: MarkInAppChatConversationReadArgs) { return ensureConfigured().markInAppChatConversationRead(args) },
  resolveInAppChatConversation(args: ResolveInAppChatConversationArgs) { return ensureConfigured().resolveInAppChatConversation(args) },

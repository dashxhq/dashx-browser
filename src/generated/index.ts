...
export type ConversationSubChannel =
  | 'ANDROID'
  | 'DASHX'
  | 'IOS'
  | 'MICROSOFT_TEAMS'
...
export type FetchInAppMessagesAggregateInput = {
  accountUid: Scalars['String']['input'];
  filter?: InputMaybe<Scalars['JSON']['input']>;
  targetEnvironment?: InputMaybe<Scalars['String']['input']>;
};

export type FetchInAppMessagesInput = {
  accountUid: Scalars['String']['input'];
  filter?: InputMaybe<Scalars['JSON']['input']>;
...
export type SubscribeContactInput = {
  accountAnonymousUid?: InputMaybe<Scalars['String']['input']>;
  accountUid?: InputMaybe<Scalars['String']['input']>;
  deviceAdvertisingUid?: InputMaybe<Scalars['String']['input']>;
  ...
  isDeviceAdTrackingEnabled?: InputMaybe<Scalars['Boolean']['input']>;
  kind: ContactKind;
...
export type TrackMessageStatus =
  | 'CLICKED'
  | 'DELIVERED'
  | 'DISMISSED'
  | 'OPENED'
...
export type ChatConversationSummaryFragmentFragment = { __typename?: 'ChatConversationSummary', conversationId: any, category: string, status: string, title: string, lastMessagePreview?: string | null, lastMessageAt?: string | null, lastSenderKind?: string | null, activityAt: string, unreadCount: number, context?: { __typename?: 'ChatConversationContext', kind: string, subtype?: string | null, id: string, reference?: string | null, name?: string | null } | null, topic?: { __typename?: 'ChatConversationTopic', id: string, label: string } | null, assignedGroups: Array<{ __typename?: 'AssignedGroupSummary', id: string, name: string }> };
...
export type ConversationFragmentFragment = { __typename?: 'Conversation', id: any, workspaceId: any, kind: ConversationKind, name?: string | null, channel: ConversationChannel, subChannel?: ConversationSubChannel | null, environmentId: any, idempotencyKey?: string | null, createdAt: any, updatedAt: any, messages: Array<{ __typename?: 'Message', id: any, attachments?: Array<any> | null, broadcastId?: any | null, conversationId?: any | null, integrationId?: any | null, data?: any | null, renderedContent: any, report?: any | null, failedSendAttempts: number, failedDeliveryAttempts?: number | null, lastDeliveryFailureAt?: any | null, lastSendFailureAt?: any | null, failureReason?: string | null, unsubscribedAt?: any | null, firstClickedAt?: any | null, complainedAt?: any | null, failedAt?: any | null, sentAt?: any | null, deliveredAt?: any | null, firstOpenedAt?: any | null, externalUid?: string | null, queuedAt?: any | null, createdAt: any, updatedAt: any }> };

export type ConversationsListQueryVariables = Exact<{
  filter?: InputMaybe<Scalars['JSON']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<Scalars['JSON']['input']> | Scalars['JSON']['input']>;
  page?: InputMaybe<Scalars['Int']['input']>;
}>;


export type ConversationsListQuery = { __typename?: 'Query', conversationsList: Array<{ __typename?: 'Conversation', id: any, workspaceId: any, kind: ConversationKind, name?: string | null, channel: ConversationChannel, subChannel?: ConversationSubChannel | null, environmentId: any, idempotencyKey?: string | null, createdAt: any, updatedAt: any, messages: Array<{ __typename?: 'Message', id: any, attachments?: Array<any> | null, broadcastId?: any | null, conversationId?: any | null, integrationId?: any | null, data?: any | null, renderedContent: any, report?: any | null, failedSendAttempts: number, failedDeliveryAttempts?: number | null, lastDeliveryFailureAt?: any | null, lastSendFailureAt?: any | null, failureReason?: string | null, unsubscribedAt?: any | null, firstClickedAt?: any | null, complainedAt?: any | null, failedAt?: any | null, sentAt?: any | null, deliveredAt?: any | null, firstOpenedAt?: any | null, externalUid?: string | null, queuedAt?: any | null, createdAt: any, updatedAt: any }> }> };
...
export type FetchInAppChatConversationQueryVariables = Exact<{
  identityId: Scalars['UUID']['input'];
  conversationId: Scalars['UUID']['input'];
}>;


export type FetchInAppChatConversationQuery = { __typename?: 'Query', fetchInAppChatConversation: { __typename?: 'ChatConversationSummary', conversationId: any, category: string, status: string, title: string, lastMessagePreview?: string | null, lastMessageAt?: string | null, lastSenderKind?: string | null, activityAt: string, unreadCount: number, context?: { __typename?: 'ChatConversationContext', kind: string, subtype?: string | null, id: string, reference?: string | null, name?: string | null } | null, topic?: { __typename?: 'ChatConversationTopic', id: string, label: string } | null, assignedGroups: Array<{ __typename?: 'AssignedGroupSummary', id: string, name: string }> } };

export type FetchInAppChatConversationsQueryVariables = Exact<{
  identityId: Scalars['UUID']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
  page?: InputMaybe<Scalars['Int']['input']>;
...
export type FetchInAppChatConversationsQuery = { __typename?: 'Query', fetchInAppChatConversations: Array<{ __typename?: 'ChatConversationSummary', conversationId: any, category: string, status: string, title: string, lastMessagePreview?: string | null, lastMessageAt?: string | null, lastSenderKind?: string | null, activityAt: string, unreadCount: number, context?: { __typename?: 'ChatConversationContext', kind: string, subtype?: string | null, id: string, reference?: string | null, name?: string | null } | null, topic?: { __typename?: 'ChatConversationTopic', id: string, label: string } | null, assignedGroups: Array<{ __typename?: 'AssignedGroupSummary', id: string, name: string }> }> };

export type FetchInAppChatMessagesQueryVariables = Exact<{
  conversationId: Scalars['UUID']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
  page?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type FetchInAppChatMessagesQuery = { __typename?: 'Query', fetchInAppChatMessages: Array<{ __typename?: 'Message', id: any, conversationId?: any | null, renderedContent: any, externalUid?: string | null, senderId?: any | null, aiRole?: string | null, sentAt?: any | null, createdAt: any }> };

export type FetchInAppMessagesQueryVariables = Exact<{
  input: FetchInAppMessagesInput;
}>;


export type FetchInAppMessagesQuery = { __typename?: 'Query', messages: Array<{ __typename?: 'Message', id: any, sentAt?: any | null, readAt?: any | null, renderedContent: any }> };

export type FetchInAppMessagesAggregateQueryVariables = Exact<{
  input: FetchInAppMessagesAggregateInput;
}>;


export type FetchInAppMessagesAggregateQuery = { __typename?: 'Query', messagesAggregate: { __typename?: 'FetchInAppMessagesAggregateResponse', count?: number | null } };
...
export type InvokeAiAgentQuery = { __typename?: 'Query', invokeAiAgent: { __typename?: 'InvokeAiAgentResponse', messages: Array<{ __typename?: 'Message', id: any, attachments?: Array<any> | null, broadcastId?: any | null, conversationId?: any | null, integrationId?: any | null, data?: any | null, renderedContent: any, report?: any | null, failedSendAttempts: number, failedDeliveryAttempts?: number | null, lastDeliveryFailureAt?: any | null, lastSendFailureAt?: any | null, failureReason?: string | null, unsubscribedAt?: any | null, firstClickedAt?: any | null, complainedAt?: any | null, failedAt?: any | null, sentAt?: any | null, deliveredAt?: any | null, firstOpenedAt?: any | null, externalUid?: string | null, queuedAt?: any | null, createdAt: any, updatedAt: any }> } };
...
export type MarkInAppChatConversationReadMutationVariables = Exact<{
  identityId: Scalars['UUID']['input'];
  conversationId: Scalars['UUID']['input'];
  lastMessageId: Scalars['UUID']['input'];
}>;


export type MarkInAppChatConversationReadMutation = { __typename?: 'Mutation', markInAppChatConversationRead: { __typename?: 'MarkInAppChatConversationReadResponse', success: boolean } };

export type MessageFragmentFragment = { __typename?: 'Message', id: any, attachments?: Array<any> | null, broadcastId?: any | null, conversationId?: any | null, integrationId?: any | null, data?: any | null, renderedContent: any, report?: any | null, failedSendAttempts: number, failedDeliveryAttempts?: number | null, lastDeliveryFailureAt?: any | null, lastSendFailureAt?: any | null, failureReason?: string | null, unsubscribedAt?: any | null, firstClickedAt?: any | null, complainedAt?: any | null, failedAt?: any | null, sentAt?: any | null, deliveredAt?: any | null, firstOpenedAt?: any | null, externalUid?: string | null, queuedAt?: any | null, createdAt: any, updatedAt: any };
...
export type ResolveInAppChatConversationMutationVariables = Exact<{
  identityId: Scalars['UUID']['input'];
  conversationId: Scalars['UUID']['input'];
}>;


export type ResolveInAppChatConversationMutation = { __typename?: 'Mutation', resolveInAppChatConversation: { __typename?: 'ChatConversationSummary', conversationId: any, category: string, status: string, title: string, lastMessagePreview?: string | null, lastMessageAt?: string | null, lastSenderKind?: string | null, activityAt: string, unreadCount: number, context?: { __typename?: 'ChatConversationContext', kind: string, subtype?: string | null, id: string, reference?: string | null, name?: string | null } | null, topic?: { __typename?: 'ChatConversationTopic', id: string, label: string } | null, assignedGroups: Array<{ __typename?: 'AssignedGroupSummary', id: string, name: string }> } };
...
export type SendInAppChatMessageMutationVariables = Exact<{
  conversationId: Scalars['UUID']['input'];
  identityId: Scalars['UUID']['input'];
...
export type SendInAppChatMessageMutation = { __typename?: 'Mutation', sendInAppChatMessage: { __typename?: 'Message', id: any, conversationId?: any | null, renderedContent: any, externalUid?: string | null, senderId?: any | null, aiRole?: string | null, sentAt?: any | null, createdAt: any } };

export type StartInAppChatConversationMutationVariables = Exact<{
  identityId: Scalars['UUID']['input'];
  clientIdempotencyKey: Scalars['String']['input'];
  content?: InputMaybe<Scalars['JSON']['input']>;
  clientMessageId?: InputMaybe<Scalars['String']['input']>;
  data?: InputMaybe<Scalars['JSON']['input']>;
  issueProperties?: InputMaybe<Scalars['JSON']['input']>;
}>;


export type StartInAppChatConversationMutation = { __typename?: 'Mutation', startInAppChatConversation: { __typename?: 'Conversation', id: any } };
...
export type SubscribeContactMutation = { __typename?: 'Mutation', subscribeContact: { __typename?: 'Contact', id: any, value: string } };

export type SummarizeInAppChatConversationsQueryVariables = Exact<{
  identityId: Scalars['UUID']['input'];
  statuses?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
  properties?: InputMaybe<Scalars['JSON']['input']>;
}>;
...
export type SummarizeInAppChatConversationsQuery = { __typename?: 'Query', summarizeInAppChatConversations: { __typename?: 'SummarizeInAppChatConversationsResponse', count: number } };

export type SummarizeInAppChatMessagesQueryVariables = Exact<{
  conversationId: Scalars['UUID']['input'];
}>;


export type SummarizeInAppChatMessagesQuery = { __typename?: 'Query', summarizeInAppChatMessages: { __typename?: 'SummarizeInAppChatMessagesResponse', count: number } };

export type SummarizeInAppChatUnreadQueryVariables = Exact<{
  identityId: Scalars['UUID']['input'];
}>;


export type SummarizeInAppChatUnreadQuery = { __typename?: 'Query', summarizeInAppChatUnread: { __typename?: 'SummarizeInAppChatUnreadResponse', count: number } };
...
export type TrackMessageMutation = { __typename?: 'Mutation', trackMessage: { __typename?: 'TrackMessageResponse', success: boolean } };
...
export type UnsubscribeContactMutation = { __typename?: 'Mutation', unsubscribeContact: { __typename?: 'UnsubscribeContactResponse', success: boolean } };
...
export const ChatConversationSummaryFragmentFragmentDoc = {'kind':'Document','definitions':[ {'kind':'FragmentDefinition','name':{'kind':'Name','value':'ChatConversationSummaryFragment'},'typeCondition':{'kind':'NamedType','name':{'kind':'Name','value':'ChatConversationSummary'}},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'conversationId'}},{'kind':'Field','name':{'kind':'Name','value':'category'}},{'kind':'Field','name':{'kind':'Name','value':'context'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'kind'}},{'kind':'Field','name':{'kind':'Name','value':'subtype'}},{'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'reference'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'topic'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'label'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'status'}},{'kind':'Field','name':{'kind':'Name','value':'title'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessagePreview'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessageAt'}},{'kind':'Field','name':{'kind':'Name','value':'lastSenderKind'}},{'kind':'Field','name':{'kind':'Name','value':'activityAt'}},{'kind':'Field','name':{'kind':'Name','value':'assignedGroups'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'unreadCount'}} ]}} ]} as unknown as DocumentNode<ChatConversationSummaryFragmentFragment, unknown>
...
export const ConversationsListDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'query','name':{'kind':'Name','value':'ConversationsList'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'filter'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'limit'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'Int'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'order'}},'type':{'kind':'ListType','type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'page'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'Int'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'conversationsList'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'filter'},'value':{'kind':'Variable','name':{'kind':'Name','value':'filter'}}},{'kind':'Argument','name':{'kind':'Name','value':'limit'},'value':{'kind':'Variable','name':{'kind':'Name','value':'limit'}}},{'kind':'Argument','name':{'kind':'Name','value':'order'},'value':{'kind':'Variable','name':{'kind':'Name','value':'order'}}},{'kind':'Argument','name':{'kind':'Name','value':'page'},'value':{'kind':'Variable','name':{'kind':'Name','value':'page'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'FragmentSpread','name':{'kind':'Name','value':'ConversationFragment'}} ]}} ]}},{'kind':'FragmentDefinition','name':{'kind':'Name','value':'MessageFragment'},'typeCondition':{'kind':'NamedType','name':{'kind':'Name','value':'Message'}},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'attachments'}},{'kind':'Field','name':{'kind':'Name','value':'broadcastId'}},{'kind':'Field','name':{'kind':'Name','value':'conversationId'}},{'kind':'Field','name':{'kind':'Name','value':'integrationId'}},{'kind':'Field','name':{'kind':'Name','value':'data'}},{'kind':'Field','name':{'kind':'Name','value':'renderedContent'}},{'kind':'Field','name':{'kind':'Name','value':'report'}},{'kind':'Field','name':{'kind':'Name','value':'failedSendAttempts'}},{'kind':'Field','name':{'kind':'Name','value':'failedDeliveryAttempts'}},{'kind':'Field','name':{'kind':'Name','value':'lastDeliveryFailureAt'}},{'kind':'Field','name':{'kind':'Name','value':'lastSendFailureAt'}},{'kind':'Field','name':{'kind':'Name','value':'failureReason'}},{'kind':'Field','name':{'kind':'Name','value':'unsubscribedAt'}},{'kind':'Field','name':{'kind':'Name','value':'firstClickedAt'}},{'kind':'Field','name':{'kind':'Name','value':'complainedAt'}},{'kind':'Field','name':{'kind':'Name','value':'failedAt'}},{'kind':'Field','name':{'kind':'Name','value':'sentAt'}},{'kind':'Field','name':{'kind':'Name','value':'deliveredAt'}},{'kind':'Field','name':{'kind':'Name','value':'firstOpenedAt'}},{'kind':'Field','name':{'kind':'Name','value':'externalUid'}},{'kind':'Field','name':{'kind':'Name','value':'queuedAt'}},{'kind':'Field','name':{'kind':'Name','value':'createdAt'}},{'kind':'Field','name':{'kind':'Name','value':'updatedAt'}} ]}},{'kind':'FragmentDefinition','name':{'kind':'Name','value':'ConversationFragment'},'typeCondition':{'kind':'NamedType','name':{'kind':'Name','value':'Conversation'}},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'workspaceId'}},{'kind':'Field','name':{'kind':'Name','value':'kind'}},{'kind':'Field','name':{'kind':'Name','value':'name'}},{'kind':'Field','name':{'kind':'Name','value':'channel'}},{'kind':'Field','name':{'kind':'Name','value':'subChannel'}},{'kind':'Field','name':{'kind':'Name','value':'environmentId'}},{'kind':'Field','name':{'kind':'Name','value':'idempotencyKey'}},{'kind':'Field','name':{'kind':'Name','value':'createdAt'}},{'kind':'Field','name':{'kind':'Name','value':'updatedAt'}},{'kind':'Field','name':{'kind':'Name','value':'messages'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'FragmentSpread','name':{'kind':'Name','value':'MessageFragment'}} ]}} ]}} ]} as unknown as DocumentNode<ConversationsListQuery, ConversationsListQueryVariables>
...
export const FetchInAppChatConversationDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'query','name':{'kind':'Name','value':'FetchInAppChatConversation'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'fetchInAppChatConversation'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'identityId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'conversationId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'FragmentSpread','name':{'kind':'Name','value':'ChatConversationSummaryFragment'}} ]}} ]}},{'kind':'FragmentDefinition','name':{'kind':'Name','value':'ChatConversationSummaryFragment'},'typeCondition':{'kind':'NamedType','name':{'kind':'Name','value':'ChatConversationSummary'}},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'conversationId'}},{'kind':'Field','name':{'kind':'Name','value':'category'}},{'kind':'Field','name':{'kind':'Name','value':'context'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'kind'}},{'kind':'Field','name':{'kind':'Name','value':'subtype'}},{'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'reference'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'topic'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'label'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'status'}},{'kind':'Field','name':{'kind':'Name','value':'title'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessagePreview'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessageAt'}},{'kind':'Field','name':{'kind':'Name','value':'lastSenderKind'}},{'kind':'Field','name':{'kind':'Name','value':'activityAt'}},{'kind':'Field','name':{'kind':'Name','value':'assignedGroups'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'unreadCount'}} ]}} ]} as unknown as DocumentNode<FetchInAppChatConversationQuery, FetchInAppChatConversationQueryVariables>
export const FetchInAppChatConversationsDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'query','name':{'kind':'Name','value':'FetchInAppChatConversations'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'limit'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'Int'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'page'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'Int'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'statuses'}},'type':{'kind':'ListType','type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'String'}}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'properties'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'fetchInAppChatConversations'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'identityId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'limit'},'value':{'kind':'Variable','name':{'kind':'Name','value':'limit'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'page'},'value':{'kind':'Variable','name':{'kind':'Name','value':'page'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'statuses'},'value':{'kind':'Variable','name':{'kind':'Name','value':'statuses'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'properties'},'value':{'kind':'Variable','name':{'kind':'Name','value':'properties'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'FragmentSpread','name':{'kind':'Name','value':'ChatConversationSummaryFragment'}} ]}} ]}},{'kind':'FragmentDefinition','name':{'kind':'Name','value':'ChatConversationSummaryFragment'},'typeCondition':{'kind':'NamedType','name':{'kind':'Name','value':'ChatConversationSummary'}},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'conversationId'}},{'kind':'Field','name':{'kind':'Name','value':'category'}},{'kind':'Field','name':{'kind':'Name','value':'context'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'kind'}},{'kind':'Field','name':{'kind':'Name','value':'subtype'}},{'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'reference'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'topic'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'label'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'status'}},{'kind':'Field','name':{'kind':'Name','value':'title'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessagePreview'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessageAt'}},{'kind':'Field','name':{'kind':'Name','value':'lastSenderKind'}},{'kind':'Field','name':{'kind':'Name','value':'activityAt'}},{'kind':'Field','name':{'kind':'Name','value':'assignedGroups'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'unreadCount'}} ]}} ]} as unknown as DocumentNode<FetchInAppChatConversationsQuery, FetchInAppChatConversationsQueryVariables>
export const FetchInAppChatMessagesDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'query','name':{'kind':'Name','value':'FetchInAppChatMessages'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'limit'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'Int'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'page'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'Int'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'fetchInAppChatMessages'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'conversationId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'limit'},'value':{'kind':'Variable','name':{'kind':'Name','value':'limit'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'page'},'value':{'kind':'Variable','name':{'kind':'Name','value':'page'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'conversationId'}},{'kind':'Field','name':{'kind':'Name','value':'renderedContent'}},{'kind':'Field','name':{'kind':'Name','value':'externalUid'}},{'kind':'Field','name':{'kind':'Name','value':'senderId'}},{'kind':'Field','name':{'kind':'Name','value':'aiRole'}},{'kind':'Field','name':{'kind':'Name','value':'sentAt'}},{'kind':'Field','name':{'kind':'Name','value':'createdAt'}} ]}} ]}} ]} as unknown as DocumentNode<FetchInAppChatMessagesQuery, FetchInAppChatMessagesQueryVariables>
export const FetchInAppMessagesDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'query','name':{'kind':'Name','value':'FetchInAppMessages'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'input'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'FetchInAppMessagesInput'}}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','alias':{'kind':'Name','value':'messages'},'name':{'kind':'Name','value':'fetchInAppMessages'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'Variable','name':{'kind':'Name','value':'input'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'sentAt'}},{'kind':'Field','name':{'kind':'Name','value':'readAt'}},{'kind':'Field','name':{'kind':'Name','value':'renderedContent'}} ]}} ]}} ]} as unknown as DocumentNode<FetchInAppMessagesQuery, FetchInAppMessagesQueryVariables>
export const FetchInAppMessagesAggregateDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'query','name':{'kind':'Name','value':'FetchInAppMessagesAggregate'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'input'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'FetchInAppMessagesAggregateInput'}}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','alias':{'kind':'Name','value':'messagesAggregate'},'name':{'kind':'Name','value':'fetchInAppMessagesAggregate'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'Variable','name':{'kind':'Name','value':'input'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'count'}} ]}} ]}} ]} as unknown as DocumentNode<FetchInAppMessagesAggregateQuery, FetchInAppMessagesAggregateQueryVariables>
...
export const MarkInAppChatConversationReadDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'mutation','name':{'kind':'Name','value':'MarkInAppChatConversationRead'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'lastMessageId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'markInAppChatConversationRead'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'identityId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'conversationId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'lastMessageId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'lastMessageId'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'success'}} ]}} ]}} ]} as unknown as DocumentNode<MarkInAppChatConversationReadMutation, MarkInAppChatConversationReadMutationVariables>
...
export const ResolveInAppChatConversationDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'mutation','name':{'kind':'Name','value':'ResolveInAppChatConversation'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'resolveInAppChatConversation'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'identityId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'conversationId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'FragmentSpread','name':{'kind':'Name','value':'ChatConversationSummaryFragment'}} ]}} ]}},{'kind':'FragmentDefinition','name':{'kind':'Name','value':'ChatConversationSummaryFragment'},'typeCondition':{'kind':'NamedType','name':{'kind':'Name','value':'ChatConversationSummary'}},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'conversationId'}},{'kind':'Field','name':{'kind':'Name','value':'category'}},{'kind':'Field','name':{'kind':'Name','value':'context'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'kind'}},{'kind':'Field','name':{'kind':'Name','value':'subtype'}},{'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'reference'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'topic'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'label'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'status'}},{'kind':'Field','name':{'kind':'Name','value':'title'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessagePreview'}},{'kind':'Field','name':{'kind':'Name','value':'lastMessageAt'}},{'kind':'Field','name':{'kind':'Name','value':'lastSenderKind'}},{'kind':'Field','name':{'kind':'Name','value':'activityAt'}},{'kind':'Field','name':{'kind':'Name','value':'assignedGroups'},'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'name'}} ]}},{'kind':'Field','name':{'kind':'Name','value':'unreadCount'}} ]}} ]} as unknown as DocumentNode<ResolveInAppChatConversationMutation, ResolveInAppChatConversationMutationVariables>
...
export const SendInAppChatMessageDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'mutation','name':{'kind':'Name','value':'SendInAppChatMessage'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'content'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'clientMessageId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'String'}}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'sendInAppChatMessage'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'conversationId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'conversationId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'identityId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'content'},'value':{'kind':'Variable','name':{'kind':'Name','value':'content'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'clientMessageId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'clientMessageId'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'conversationId'}},{'kind':'Field','name':{'kind':'Name','value':'renderedContent'}},{'kind':'Field','name':{'kind':'Name','value':'externalUid'}},{'kind':'Field','name':{'kind':'Name','value':'senderId'}},{'kind':'Field','name':{'kind':'Name','value':'aiRole'}},{'kind':'Field','name':{'kind':'Name','value':'sentAt'}},{'kind':'Field','name':{'kind':'Name','value':'createdAt'}} ]}} ]}} ]} as unknown as DocumentNode<SendInAppChatMessageMutation, SendInAppChatMessageMutationVariables>
export const StartInAppChatConversationDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'mutation','name':{'kind':'Name','value':'StartInAppChatConversation'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'clientIdempotencyKey'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'String'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'content'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'clientMessageId'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'String'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'data'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'issueProperties'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'startInAppChatConversation'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'identityId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'clientIdempotencyKey'},'value':{'kind':'Variable','name':{'kind':'Name','value':'clientIdempotencyKey'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'content'},'value':{'kind':'Variable','name':{'kind':'Name','value':'content'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'clientMessageId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'clientMessageId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'data'},'value':{'kind':'Variable','name':{'kind':'Name','value':'data'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'issueProperties'},'value':{'kind':'Variable','name':{'kind':'Name','value':'issueProperties'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}} ]}} ]}} ]} as unknown as DocumentNode<StartInAppChatConversationMutation, StartInAppChatConversationMutationVariables>
export const SubscribeContactDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'mutation','name':{'kind':'Name','value':'SubscribeContact'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'input'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'SubscribeContactInput'}}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'subscribeContact'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'Variable','name':{'kind':'Name','value':'input'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'id'}},{'kind':'Field','name':{'kind':'Name','value':'value'}} ]}} ]}} ]} as unknown as DocumentNode<SubscribeContactMutation, SubscribeContactMutationVariables>
export const SummarizeInAppChatConversationsDocument = {'kind':'Document','definitions':[ {'kind':'OperationDefinition','operation':'query','name':{'kind':'Name','value':'SummarizeInAppChatConversations'},'variableDefinitions':[ {'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}},'type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'UUID'}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'statuses'}},'type':{'kind':'ListType','type':{'kind':'NonNullType','type':{'kind':'NamedType','name':{'kind':'Name','value':'String'}}}}},{'kind':'VariableDefinition','variable':{'kind':'Variable','name':{'kind':'Name','value':'properties'}},'type':{'kind':'NamedType','name':{'kind':'Name','value':'JSON'}}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'summarizeInAppChatConversations'},'arguments':[ {'kind':'Argument','name':{'kind':'Name','value':'input'},'value':{'kind':'ObjectValue','fields':[ {'kind':'ObjectField','name':{'kind':'Name','value':'identityId'},'value':{'kind':'Variable','name':{'kind':'Name','value':'identityId'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'statuses'},'value':{'kind':'Variable','name':{'kind':'Name','value':'statuses'}}},{'kind':'ObjectField','name':{'kind':'Name','value':'properties'},'value':{'kind':'Variable','name':{'kind':'Name','value':'properties'}}} ]}} ],'selectionSet':{'kind':'SelectionSet','selections':[ {'kind':'Field','name':{'kind':'Name','value':'count'}} ]}} ]}} ]} as unknown as DocumentNode<SummarizeInAppChatConversationsQuery, SummarizeInAppChatConversationsQueryVariables>
